...
class OpenViduRecordingResolutionException extends OpenViduException
{
    ...
    {
        parent::__construct(__('"Resolution" parameter exceeds acceptable values (for both width and height, min 100px and max 1999px) or trying to start a recording with both "hasAudio" and "hasVideo" to false'), 422, $previous);
    }
